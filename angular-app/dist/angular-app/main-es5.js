(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function _(module, exports, __webpack_require__) {
      ...
      /*! /Users/hussainalsabr/Desktop/My Files/Self Development/typescript-projects/Mastering-TypeScript-Fourth-Edition/ch16/angular-app/src/main.ts */
      "zUnb");
      /***/
    },
    ...
    /***/
    function Ev3c(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "EventKeys", function () {
        return EventKeys;
      });
      /* harmony export (binding) */


      __webpack_require__.d(__webpack_exports__, "AngularBroadcastService", function () {
        return AngularBroadcastService;
      });
      /* harmony import */
      ...
      var AngularBroadcastService = /*#__PURE__*/function () {
        function AngularBroadcastService() {
          _classCallCheck(this, AngularBroadcastService);

          this.eventBus = new rxjs__WEBPACK_IMPORTED_MODULE_1__["Subject"]();
        }

        _createClass(AngularBroadcastService, [{
          key: "on",
          value: function on(key) {
            return this.eventBus.asObservable().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["filter"])(function (event) {
              return event.key === key || event.key === EventKeys.ALL;
      ...
      AngularBroadcastService.ɵfac = function AngularBroadcastService_Factory(t) {
        return new (t || AngularBroadcastService)();
      };

      AngularBroadcastService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
        token: AngularBroadcastService,
        factory: AngularBroadcastService.ɵfac,
        providedIn: 'root'
      });
      /*@__PURE__*/

      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AngularBroadcastService, [{
    ...
    function Sy1n(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "microEventBus", function () {
      ...
      var _services_broadcast_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      ...
      var _services_ScriptLoaderService__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      ...
      var AppComponent = /*#__PURE__*/function () {
        function AppComponent(broadCastService, scriptLoaderService, cd) {
          ...
          this.sidenav = null;
          lodash__WEBPACK_IMPORTED_MODULE_2__["bindAll"](this, ["onLoginClicked", "onLoginEvent", "toggleCheckoutOnly", "toggleContinueShopping", "togglePlaceOrder"]);
          broadCastService.on(_services_broadcast_service__WEBPACK_IMPORTED_MODULE_1__["EventKeys"].LOGIN_BUTTON_CLICKED).subscribe(this.onLoginClicked);
          broadCastService.on(_services_broadcast_service__WEBPACK_IMPORTED_MODULE_1__["EventKeys"].USER_LOGIN_EVENT).subscribe(this.onLoginEvent);
          microEventBus.on("checking-out").subscribe(this.toggleCheckoutOnly);
          microEventBus.on("continue-shopping").subscribe(this.toggleContinueShopping);
          microEventBus.on("place-order").subscribe(this.togglePlaceOrder);
        }
        ...
        _createClass(AppComponent, [{
          ...
          value: function ngOnInit() {
            // createReactApp();
            this.scriptLoaderService.loadAllScripts("/assets/react/build/static/js/2.c1473afa.chunk.js", "/assets/react/build/static/js/main.f4a103d4.chunk.js").subscribe(function () {
          ...
          key: "onLoginClicked",
          value: function onLoginClicked(event) {
            var _a;

            console.log("AppComponent received : ".concat(event));
            (_a = this.sidenav) === null || _a === void 0 ? void 0 : _a.open();
          }
        }, {
          key: "onLoginEvent",
          value: function onLoginEvent(username) {
            var _a;
          ...
          key: "toggleCheckoutOnly",
          value: function toggleCheckoutOnly() {
            this.shoppingCartStyles = "split";
            this.hideProducts = true;
            this.cd.detectChanges();
          }
        }, {
          key: "toggleContinueShopping",
          value: function toggleContinueShopping() {
            this.shoppingCartStyles = "split right";
            this.hideProducts = false;
            this.cd.detectChanges();
          }
        }, {
          key: "togglePlaceOrder",
          value: function togglePlaceOrder() {
      ...
      AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 28,
        vars: 13,
        consts: [[1, "full-height-container"], ["mode", "over", 1, "content-padding", 3, "fixedInViewport", "fixedTopGap", "fixedBottomGap", "opened"], ["sidenav", ""], [1, "content-padding"], [1, "split", "left", 3, "hidden"], ["id", "root"], [3, "hidden"], [4, "ngIf"], ["id", "vue-application", 3, "hidden"]],
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AppComponent, [{
          ...
          return [{
            type: _services_broadcast_service__WEBPACK_IMPORTED_MODULE_1__["AngularBroadcastService"]
          }, {
            type: _services_ScriptLoaderService__WEBPACK_IMPORTED_MODULE_3__["ScriptLoaderService"]
          }, {
    ...
    function ZAI4(module, __webpack_exports__, __webpack_require__) {
      ...
      var _services_broadcast_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./services/broadcast.service */
      "Ev3c");
      /* harmony import */
      ...
      var _services_ScriptLoaderService__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ./services/ScriptLoaderService */
      "qt3J");
      /* harmony import */
      ...
      AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
        ...
        providers: [_services_broadcast_service__WEBPACK_IMPORTED_MODULE_6__["AngularBroadcastService"], _services_ScriptLoaderService__WEBPACK_IMPORTED_MODULE_9__["ScriptLoaderService"]],
        imports: [[_app_routing_module__WEBPACK_IMPORTED_MODULE_1__["AppRoutingModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_4__["SharedModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_8__["HttpClientModule"]]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](AppModule, {
          declarations: [_app_component__WEBPACK_IMPORTED_MODULE_2__["AppComponent"], _header_header_component__WEBPACK_IMPORTED_MODULE_3__["HeaderComponent"], _user_details_user_details_component__WEBPACK_IMPORTED_MODULE_5__["UserDetailsComponent"], _login_login_component__WEBPACK_IMPORTED_MODULE_7__["LoginComponent"]],
          imports: [_app_routing_module__WEBPACK_IMPORTED_MODULE_1__["AppRoutingModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_4__["SharedModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_8__["HttpClientModule"]]
        });
      })();
      /*@__PURE__*/
    ...
    function eFEo(module, __webpack_exports__, __webpack_require__) {
      ...
      var _services_broadcast_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ../services/broadcast.service */
      "Ev3c");
      /* harmony import */
      ...
      function UserDetailsComponent_span_0_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function UserDetailsComponent_button_1_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function UserDetailsComponent_button_2_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function UserDetailsComponent_button_2_Template_button_click_0_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r5);

            var ctx_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

            return ctx_r4.onLogoutClicked();
          });
      ...
      function UserDetailsComponent_button_3_Template(rf, ctx) {
        if (rf & 1) {
          var _r7 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 5);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function UserDetailsComponent_button_3_Template_button_click_0_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r7);

            var ctx_r6 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

            return ctx_r6.onLoginClicked();
          });
      ...
      var UserDetailsComponent = /*#__PURE__*/function () {
        function UserDetailsComponent(broadcastService) {
          ...
          this.broadcastService.on(_services_broadcast_service__WEBPACK_IMPORTED_MODULE_2__["EventKeys"].USER_LOGIN_EVENT).subscribe(this.loginSuccessful);
        }
        ...
        _createClass(UserDetailsComponent, [{
          ...
          key: "loginSuccessful",
          value: function loginSuccessful(event) {
            console.log("UserDetailsComponent.loginSuccessful : ".concat(event));
      ...
      UserDetailsComponent.ɵfac = function UserDetailsComponent_Factory(t) {
        return new (t || UserDetailsComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_broadcast_service__WEBPACK_IMPORTED_MODULE_2__["AngularBroadcastService"]));
      };
      ...
      UserDetailsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 4,
        vars: 4,
        consts: [["class", "username-span", 4, "ngIf"], ["mat-icon-button", "", "color", "white", 4, "ngIf"], ["mat-icon-button", "", "color", "white", 3, "click", 4, "ngIf"], [1, "username-span"], ["mat-icon-button", "", "color", "white"], ["mat-icon-button", "", "color", "white", 3, "click"]],
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](UserDetailsComponent, [{
          ...
          return [{
            type: _services_broadcast_service__WEBPACK_IMPORTED_MODULE_2__["AngularBroadcastService"]
          }];
        }, {
          notify: [{
    ...
    function fECr(module, __webpack_exports__, __webpack_require__) {
      ...
      var _user_details_user_details_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ../user-details/user-details.component */
      "eFEo");
      ...
      var HeaderComponent = /*#__PURE__*/function () {
        ...
        _createClass(HeaderComponent, [{
          ...
          key: "onUserDetailsEvent",
          value: function onUserDetailsEvent(event) {
      ...
      HeaderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 5,
        vars: 0,
        consts: [["color", "primary"], [1, "example-spacer"], [3, "notify"]],
        template: function HeaderComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("notify", function HeaderComponent_Template_app_user_details_notify_4_listener($event) {
              return ctx.onUserDetailsEvent($event);
            });
        ...
        directives: [_angular_material_toolbar__WEBPACK_IMPORTED_MODULE_1__["MatToolbar"], _user_details_user_details_component__WEBPACK_IMPORTED_MODULE_2__["UserDetailsComponent"]],
    ...
    /***/
    function qt3J(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var ScriptLoaderService = /*#__PURE__*/function () {
        ...
        _createClass(ScriptLoaderService, [{
          key: "loadAllScripts",
          value: function loadAllScripts() {
            for (var _len = arguments.length, scriptUrls = new Array(_len), _key = 0; _key < _len; _key++) {
              scriptUrls[_key] = arguments[_key];
            }
          ...
          value: function scriptAlreadyLoaded(scriptUrl) {
    ...
    function vtpD(module, __webpack_exports__, __webpack_require__) {
      ...
      var _services_broadcast_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ../services/broadcast.service */
      "Ev3c");
      /* harmony import */
      ...
      function LoginComponent_div_1_div_20_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function LoginComponent_div_1_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngSubmit", function LoginComponent_div_1_Template_form_ngSubmit_1_listener($event) {
      ...
      var LoginComponent = /*#__PURE__*/function () {
        function LoginComponent(formBuilder, broadcastService, http) {
        ...
        _createClass(LoginComponent, [{
          ...
          value: function onSubmit(event) {
            ...
            console.log("event : ".concat(event.submitter.id)); // event.submitter.id

            console.log("onSubmit: username : ".concat((_a = this.loginForm) === null || _a === void 0 ? void 0 : _a.value.username));
            console.log("onSubmit: password : ".concat((_b = this.loginForm) === null || _b === void 0 ? void 0 : _b.value.password));
            var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpHeaders"]();
            headers.append("Content-Type", "application/json");
            var userUrl = "https://n55jrj6nra.execute-api.us-east-1.amazonaws.com/Prod/users";

            if (event.submitter.id === "register_button") {
              userUrl = "https://n55jrj6nra.execute-api.us-east-1.amazonaws.com/Prod/register";
            }
            ...
            this.http.post(userUrl, {
              ...
              console.log("post complete"); // broadcast to angular components

              _this.broadcastService.broadcast(_services_broadcast_service__WEBPACK_IMPORTED_MODULE_4__["EventKeys"].USER_LOGIN_EVENT, (_a = _this.loginForm) === null || _a === void 0 ? void 0 : _a.value.username); // broadcast to micro front end apps


              _app_component__WEBPACK_IMPORTED_MODULE_3__["microEventBus"].broadcast("user-logged-in", (_b = _this.loginForm) === null || _b === void 0 ? void 0 : _b.value.username);
            }, function (error) {
              console.log("LoginComponent : error :  ".concat(JSON.stringify(error, null, 4)));
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](LoginComponent, [{
          ...
          return [{
            ...
            type: _services_broadcast_service__WEBPACK_IMPORTED_MODULE_4__["AngularBroadcastService"]
          }, {
